...
const certifications = ["SOC 2", "Zero-Knowledge", "Encrypted", "Auditable", "Open Source"];
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground leading-relaxed mb-12">
              Your agent memory is encrypted before it ever leaves your systems. 
              Zero-knowledge architecture ensures privacy across the entire network.
            </p>
